...
# start a PNG device to save the plot
png("media/5_wordcloud/wordcloud.png", width = 2000, height = 2000, units = "px", res = 320)
...
wordcloud(
  ...
  random.order = FALSE,
  random.color = TRUE,
  scale = c(2.5, 1), # range of the size of the words
